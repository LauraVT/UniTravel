...
insert into descuento values (1,"Activo",50.000,1);
insert into descuento values (2,"Activo",20.000,2);

insert into categoria values (1,"C1",1);
insert into categoria values (2,"C2",2);

insert into administrador_hotel values ("1235",25,"Juan@gmail.com","juan","7896",1);
insert into administrador_hotel values ("5698",40,"Olga@gmail.com","olga","8547",1);
